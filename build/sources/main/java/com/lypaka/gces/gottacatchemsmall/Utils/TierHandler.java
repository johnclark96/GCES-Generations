...
public class TierHandler {
    ...
    public static boolean restrictZMoves() {

        return ConfigManager.getConfigNode(4, "Z-Moves", "Restrict-Z-Moves").getBoolean();

    }

    public static String getZMovesMessage() {

        return ConfigManager.getConfigNode(4, "Z-Moves", "Restriction-Message").getString();

    }

    public static String getZMovesPermission() {

        return ConfigManager.getConfigNode(4, "Z-Moves", "Unlock-Z-Moves").getString();

    }

    public static boolean unlockZMovesOnJoin() {

        return ConfigManager.getConfigNode(4, "Z-Moves", "Unlock-Permission-Given-On-Join").getBoolean();
